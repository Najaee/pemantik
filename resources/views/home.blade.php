...
<body class="index-page">
  ...
  <!-- Menampilkan logo dari aset -->
  <img src="{{ asset('assets/img/pemantik.png') }}" alt="Logo" class="img-fluid">
</a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#services">KPA</a></li>
          <li><a href="#portfolio">Ms-Keg</a></li>
          <li><a href="#team">Ms-Var</a></li>
          <li><a href="#team">Ms-Ind</a></li>
          ...
          <li><a href="#contact">Data Tersimpan</a></li>
        </ul>
      ...
      <div class="container">
        <div class="row justify-content-center" data-aos="zoom-out">
          <div class="col-xl-7 col-lg-9 text-center">
            <h1>PEMANTIK</h1>
            <p>Penyusunan Metadata Statistik</p>
          </div>
        </div>
        <div class="text-center" data-aos="zoom-out" data-aos-delay="100">
          <a href="#about" class="btn-get-started">Isi Form</a>
        </div>
